...
const Dashboard = () => {
  ...
  // It will show if completed or failed it will do ++

  const fetchAllResumes = async()=>{
    try {
        setLoading(true)
        const response = await axioInstance.get(API_PATHS.RESUME.GET_ALL)
        // add completeion percentage to each resumes
  ...
  const handleDeleteResume = async()=>{
    ...
    try {
      await axioInstance.delete(API_PATHS.RESUME.DELETE(resumeToDelete))
  ...
  return (
    <DashboardLayout>
        <div className={styles.container}>
            ...
            {!loading && allResumes.length ===0 &&(
                <div className={styles.emptyStateWrapper}>
                    ...
                    <p className={styles.emptyText}>You have not created any resumes yet. Start building your professional resume to land your dream job</p>
                    <button className={styles.createButton} onClick={()=>setOpenCreateModel(true)}>
                        <div className={styles.createButtonOverlay}></div>
            ...
            {!loading && allResumes.length >0 && (
              <div className={styles.grid}>
                <div className={styles.newResumeCard} onClick={()=> setOpenCreateModel(true)}>
                  ...
                  <p className={styles.newResumeText}>Start building your carear</p>
                </div>
        ...
        showActionBtn actionBtnText='Delete' acitonBtnClassName = 'bg-red-600 hover:bg-red-700'
